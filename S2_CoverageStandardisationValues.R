################################################################################
# S2 Coverage standardisation values Cmin & Cmax
# AFE
# Jan 2024 & update June 2024
################################################################################
...
as.data.frame(rbind(lcovI, lcovI_d, lcovI_u)) # all PA data coverage vals
...
cmax_aggAll <- lapply(lAllAbuAgg, CmaxA) 
cmax_aggD <- lapply(lAbuAgg_d, CmaxA)
cmax_aggU <- lapply(lAbuAgg_u, CmaxA)

cmin_aggAll <- lapply(lAllAbuAgg, CminA) 
