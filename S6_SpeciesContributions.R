...
ggsave(paste0(PlotsPath, "/S6_C5_fish_cont.png"), fish_cont, width = 10, height = 8)
ggsave(paste0(PlotsPath, "/S6_C5_bi_cont.png"), bi_cont, width = 10, height = 8)
ggsave(paste0(PlotsPath, "/S6_C5_dia_cont.png"), dia_cont, width = 10, height = 8)
...
ggsave(paste0(PlotsPath, "/S6_C6_DIS_q0_fish_cont.png"), pNR_F_0d, width = 10, height = 4) # disturbed order q0
ggsave(paste0(PlotsPath, "/S6_C6_DIS_q0_bi_cont.png"), pNR_I_0d, width = 10, height = 4)
ggsave(paste0(PlotsPath, "/S6_C6_DIS_q0_dia_cont.png"), pNR_D_0d, width = 10, height = 4)

ggsave(paste0(PlotsPath, "/S6_C6_DIS_q2_fish_cont.png"), pNR_F_2d, width = 10, height = 8) # disturbed order q2
ggsave(paste0(PlotsPath, "/S6_C6_DIS_q2_bi_cont.png"), pNR_I_2d, width = 10, height = 8)
ggsave(paste0(PlotsPath, "/S6_C6_DIS_q2_dia_cont.png"), pNR_D_2d, width = 10, height = 8)
...
ggsave(paste0(PlotsPath, "/S6_C6_UNDIS_q0_fish_cont.png"), pNR_F_0u, width = 10, height = 4) # undisturbed order q0
ggsave(paste0(PlotsPath, "/S6_C6_UNDIS_q0_bi_cont.png"), pNR_I_0u, width = 10, height = 4)
ggsave(paste0(PlotsPath, "/S6_C6_UNDIS_q0_dia_cont.png"), pNR_D_0u, width = 10, height = 4)

ggsave(paste0(PlotsPath, "/S6_C6_UNDIS_q2_fish_cont.png"), pNR_F_2u, width = 10, height = 8) # undisturbed order q2
ggsave(paste0(PlotsPath, "/S6_C6_UNDIS_q2_bi_cont.png"), pNR_I_2u, width = 10, height = 8)
ggsave(paste0(PlotsPath, "/S6_C6_UNDIS_q2_dia_cont.png"), pNR_D_2u, width = 10, height = 8)
